                    ...
                    <table id="order-listing" class="table table-hover table-sm">
                      <thead>
                        <tr>
                            ...
                            <th class="text-center align-middle">BUSES</th>
                      ...
                      <tbody>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('rutas.edit', $row->id) }}" class="label text-primary action-edit" style="text-decoration: none;"><i class="ti-pencil"></i></a>
                                    <a href="{{ route('rutas.destroy', $row->id) }}" class="label text-danger action-delete" style="text-decoration: none;"><i class="ti-close"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tr>
  ...
  <script>
      $(function ()
      {
          ...
          $('.action-create').click(function ()
          {
              ...
              $form.attr('action', '{{ route('rutas.store') }}');
          });
          ...
          $('.action-edit').click(function (e)
          {
              ...
              {
                  console.log(data);
                  $form.find('#input-buses_id').val(data.ruta.buses_id);
                  $form.find('#input-origen_id').val(data.ruta.origen_id);
                  $form.find('#input-destino_id').val(data.ruta.destino_id);
